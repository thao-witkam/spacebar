...
class ArticleController extends AbstractController
{
     ...
     */
    public function show($slug, MarkdownHelper $markdown, Client $slack)
    {
...
//        $slack->sendMessage($message);
        ...
        $articleContent = <<<EOF
                         <p>Spicy *jalapeno bacon ipsum* dolor amet veniam shank in dolore. Ham hock nisi landjaeger cow,
                            lorem proident [beef ribs](http://www.arsteroid.com) aute enim veniam ut cillum pork chuck picanha. Dolore reprehenderit
...
EOF;
        ...
        return $this->render('article/show.html.twig', [
            ...
            'slug' => $slug,
            'articleContent' => $markdown->parse($articleContent),
            'comments' => $comments,
        ]);
    }
